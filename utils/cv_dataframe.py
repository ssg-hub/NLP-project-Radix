...
df["Pdf", "Name", "Phone", "Email", "Date_Of_Birth","Hobbies", "Languages"].to_pickle("assets.df_personal.pkl")
df["Pdf", "Name", "Skills", "Education", "Experience", "Previous_Job_Title"].to_pickle("assets/df_professional.pkl")